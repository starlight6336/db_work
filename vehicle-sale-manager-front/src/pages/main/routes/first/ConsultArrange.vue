<template>
    <div class="background-div">
        <el-header class="header" height="30px">咨询安排</el-header>
        <el-main class="main-div">
        <div class="tool-bar">
            <el-select v-model="toolBarData_Pre.danger" placeholder="危机等级" size="small" clearable style="margin-right: 10px">
                <el-option
            ...
            <el-input class="toolbar-input" size="small" placeholder="请输入学院" v-model="toolBarData_Pre.facility"
                      clearable></el-input>
            <el-select v-model="toolBarData_Pre.result" placeholder="初访结果" size="small" clearable>
                <el-option
                        v-for="item in resultTemplate"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value">
                </el-option>
            </el-select>
            <el-select v-model="toolBarData_Pre.state" placeholder="安排状态" size="small" clearable>
                <el-option
            ...
            <el-table
                ...
                >
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" @click="handleEnableScheduling(scope.row, scope.$index)" v-if="scope.row.state === 1" size="mini">安排咨询</el-button>
                        <el-button type="text" @click="handleOpen(scope.row, scope.$index)" v-if="(scope.row.state === 2) || (scope.row.state === 3) || (scope.row.state === 4) || (scope.row.state === 5)" size="mini">安排结果</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
        <el-dialog title="查看咨询结果" :visible.sync="consultVisible">
            ...
            <el-form>
                ...
                <el-form-item label="问题类型:">
                    <template>
                        ...
                        <span v-if="(reportData.firstVisit.problem === 9) && (reportData.firstVisit.disease ===1)">疑似-抑郁症</span>
                        <span v-if="(reportData.firstVisit.problem === 9) && (reportData.firstVisit.disease ===2)">疑似-焦虑症</span>
                        <span v-if="(reportData.firstVisit.problem === 9) && (reportData.firstVisit.disease ===3)">疑似-双向情感障碍</span>
                        <span v-if="(reportData.firstVisit.problem === 9) && (reportData.firstVisit.disease ===4)">疑似-精神分裂</span>
                        <span v-if="(reportData.firstVisit.problem === 9) && (reportData.firstVisit.disease ===5)">疑似-人格障碍</span>
                        <span v-if="(reportData.firstVisit.problem === 9) && (reportData.firstVisit.disease ===6)">疑似-强迫症</span>
                        <span v-if="(reportData.firstVisit.problem === 9) && (reportData.firstVisit.disease ===7)">疑似-恶劣环境</span>
                        <span v-if="(reportData.firstVisit.problem === 9) && (reportData.firstVisit.disease ===8)">疑似-适应障碍</span>
                        <span v-if="(reportData.firstVisit.problem === 9) && (reportData.firstVisit.disease ===9)">疑似-进食障碍</span>
                        <span v-if="(reportData.firstVisit.problem === 9) && (reportData.firstVisit.disease ===10)">疑似-社交恐惧症</span>
                        <span v-if="(reportData.firstVisit.problem === 10) && (reportData.firstVisit.disease ===1)">确诊-抑郁症</span>
                        <span v-if="(reportData.firstVisit.problem === 10) && (reportData.firstVisit.disease ===2)">确诊-焦虑症</span>
                        <span v-if="(reportData.firstVisit.problem === 10) && (reportData.firstVisit.disease ===3)">确诊-双向情感障碍</span>
                        <span v-if="(reportData.firstVisit.problem === 10) && (reportData.firstVisit.disease ===4)">确诊-精神分裂</span>
                        <span v-if="(reportData.firstVisit.problem === 10) && (reportData.firstVisit.disease ===5)">确诊-人格障碍</span>
                        <span v-if="(reportData.firstVisit.problem === 10) && (reportData.firstVisit.disease ===6)">确诊-强迫症</span>
                        <span v-if="(reportData.firstVisit.problem === 10) && (reportData.firstVisit.disease ===7)">确诊-恶劣环境</span>
                        <span v-if="(reportData.firstVisit.problem === 10) && (reportData.firstVisit.disease ===8)">确诊-适应障碍</span>
                        <span v-if="(reportData.firstVisit.problem === 10) && (reportData.firstVisit.disease ===9)">确诊-进食障碍</span>
                        <span v-if="(reportData.firstVisit.problem === 10) && (reportData.firstVisit.disease ===10)">确诊-社交恐惧症</span>
        ...
        >
            ...
            <el-dialog title="安排咨询"
                       :visible.sync="schedulingDialogEnabled"
                       width="30%">
                <el-form label-width="200" label-position="top">
                    <el-form-item label="选择咨询时间">
                        <el-select class="timeSelct" v-model="schedulingForm.time" placeholder="请选择可用的咨询时间"
                    ...
                    <el-form-item label="选择咨询员">
                        <el-select class="timeSelct" v-model="schedulingForm.teacherUID" placeholder="请选择咨询教师"
                    ...
                    <el-form-item label="选择咨询地点">
                        <el-select class="timeSelct" v-model="schedulingForm.roomID" placeholder="请选择咨询教室"
            ...
            <el-dialog title="安排结果"
                       :visible.sync="resultDialogEnabled"
                       width="30%">
                <el-form label-width="200" label-position="top">
                    <el-form-item label="咨询时间">
                        <el-select class="timeSelct" v-model="resultForm.arrangementDate"
                                   @change="schedulingFormStep1Finished"
                                   disabled
                                   style="width: 90%">
                            <el-option
                    ...
                    <el-form-item label="咨询老师">
                        <el-select class="timeSelct" v-model="resultForm.teacherName"
                                   disabled
                                   style="width: 90%">
                            <el-option
                                    v-for="item in teacherOptions"
                    ...
                    <el-form-item label="咨询教室">
                        <el-select class="timeSelct" v-model="resultForm.roomName"
                                   disabled
                                   style="width: 90%">
                            <el-option
                                    v-for="item in roomOptions"
...
import {getTime, getAvailableConsultTimeByFID, getAvailableConsultTeacherByDateTimeDay,
  getAvailableConsultRoomByDateTimeDay, addNewConsultArrange} from '../../../../api/scheduleManagement'
...
export default {
  ...
  created () {
    getPreCheckDuration().then(res => {
      ...
      getAllConsultArrange().then(resp => {
        console.log(res)
        this.tableData_Pre = resp.data
  ...
  methods: {
    ...
    handleOpen (row, index) {
      getConsultResultByID(this.tableData_Pre[index].cid).then(res => {
        console.log(res)
        this.schedulingForm.cid = this.tableData_Pre[index].cid
    ...
    parseData1 (data) {
      ...
      if (data.date === null) {
        let json = {
          arrangementDate: data.arrangementDate,
          cid: data.cid,
        ...
        this.resultForm = json
      } else {
        let s1 = data.arrangementDate
        let s2 = data.startTime
        let s3 = data.endTime
        ...
        let time = s1 + '(' + wkd + ')' + s2.substring(0, 5) + '~' + s3.substring(0, 5)
        let json = {
    ...
    submitScheduleForm () {
      this.schedulingForm.cid = this.selectedId
      let tableAttr = this.schedulingForm.time.split('|')
      addNewConsultArrange(tableAttr[0], parseInt(tableAttr[1]), tableAttr[2], tableAttr[3], this.schedulingForm.teacherUID, this.schedulingForm.roomID, this.schedulingForm.cid).then(res => {
        if (res.data === true) {
